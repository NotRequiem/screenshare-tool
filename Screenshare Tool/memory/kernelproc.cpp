...
void csrss() {
    std::wcout << L"Analyzing deleted and renamed files registered by usn journal before running checks for files executed with modified extensions..." << std::endl;
    ...
    while (!fileScanned) {
        ...
        std::wcout << L"Initializing checks to detect files executed without name..." << std::endl;
        std::wcout << L"Initializing checks to detect files executed without extension..." << std::endl;
        std::wcout << L"Initializing checks to detect files executed with modified/spoofed extension..." << std::endl;
        std::wcout << L"Initializing checks to detect dll injections..." << std::endl;
