...
void ExecutedFiles() {
    std::wcout << "Running checks to detect executed jar files in memory... " << std::endl;
    std::wcout << "Running checks to detect executed batch files in memory... " << std::endl;
    std::wcout << "Running checks to detect executed vbs files in memory... " << std::endl;
    std::wcout << "Running checks to detect executed Python script files in memory... " << std::endl;
    std::wcout << "Running checks to detect executed Powershell script files in memory... " << std::endl;
    std::wcout << "Running checks to detect accessed dll files in memory... " << std::endl;
    std::wcout << "Running checks to detect accessed exe files in memory... " << std::endl;
    Explorer();
    PcaSvcAndPlugPlay();
}