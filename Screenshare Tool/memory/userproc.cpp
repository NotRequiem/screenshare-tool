                        ...
                        while (std::getline(outputStream, line)) {
                            ...
                            if (std::regex_search(line, ExplorerAccessedFiles)) {
                                ...
                                if (printedLines.find(wline) == printedLines.end() && !IsFileSignatureValid(wline)) {
                                    std::wcout << L"AAccessed file: " << wline << std::endl;
...
void ExecutedFiles() {
    ...
    std::wcout << "[Memory Scanner] Running checks to detect executed jar files in memory... " << std::endl;
    std::wcout << "[Memory Scanner] Running checks to detect executed batch files in memory... " << std::endl;
    std::wcout << "[Memory Scanner] Running checks to detect executed vbs files in memory... " << std::endl;
    std::wcout << "[Memory Scanner] Running checks to detect executed Python script files in memory... " << std::endl;
    std::wcout << "[Memory Scanner] Running checks to detect executed Powershell script files in memory... " << std::endl;
    std::wcout << "[Memory Scanner] Running checks to detect accessed dll files in memory... " << std::endl;
    std::wcout << "[Memory Scanner] Running checks to detect accessed exe files in memory... " << std::endl;
    Console::ResetColor();
