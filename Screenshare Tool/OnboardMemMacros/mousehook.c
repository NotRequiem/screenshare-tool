...
bool InstallMouseHook() {
    ...
    printf("Mouse hook installed successfully. Ask the user to click only one time every button of their mouse.\n");
    printf("You have to see in the console the left click, middle click, right click and extended button click being detected.\n");
