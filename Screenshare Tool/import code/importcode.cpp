...
DWORD ImportCodeDetector::GetPIDForClipboardUserService() {
    ...
    // Use the LIKE operator to match services with a specific display name pattern
    // I use "LIKE" because clipboardsvcgroup is weird and has random numbers at the end of the service name
