...
void MacroStrings() {
    Console::SetColor(ConsoleColor::BrightBlue, ConsoleColor::Black);
    std::wcout << "[Macro Scanner] Running checks for deleted Logitech macro traces in memory... " << std::endl;
    std::wcout << "[Macro Scanner] Running checks for deleted Razer macro traces in memory... " << std::endl;
    std::wcout << "[Macro Scanner] Running checks for deleted SteelSeries macro traces in memory... " << std::endl;
    std::wcout << "[Macro Scanner] Running checks for deleted Onikuma macro traces in memory... " << std::endl;
    Console::ResetColor();
