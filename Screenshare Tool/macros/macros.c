...
static bool IsFileRecentlyModified(const wchar_t* filePath) {
...
static void CheckRecentFileModifications() {
    wprintf(L"Running checks to detect macro file bypasses...\n");
    wprintf(L"Running checks to detect macro file modifications...\n");
