...
void LastComputerBootTime(SYSTEMTIME& startTime) {
...
void FileTimeToLocalTimeString(const FILETIME& fileTime, std::wstring& localTimeString) {
...
void EnumerateSubkeys(const std::wstring& parentKeyPath, const SYSTEMTIME& lastBootTime, int depth = 0) {
    HKEY hKey;
    LONG result;
